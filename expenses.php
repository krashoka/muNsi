	...
	<script type="text/javascript">
		...
		//Code to display sales on sales page............
			function display(){
				$.ajax({
					method:'post',
					url:'control/purchaseDisplay.php',
					data:{'display':1,
						},
     ...
     <div class="navbar-header">
		...
		<div class="container">
			<div class="row">
				...
				<!-- SALES CONTENT -->
				<div class="col-sm-12" style="height: 100vh; padding-right: 35px">
					<div class="row" style="padding-top: 20px">

						<!-- INVOICES LIST -->
						<div class="col-sm-5">
							<div style="padding-bottom: 20px">
								<span style="font-size: 20px; font-weight: bolder;">Purchases</span>
								<button onclick="window.location.href='purchaseOrder.php'" style="float: right; color: #fff" class="btn btn-success">+&ensp;Create Purchase Order
								</button>
							</div>
							...
							<div id="sales">
								...
								<?php
									if(isset($_GET['id'])){
										...
										$query = "SELECT * FROM `purchase_order` WHERE `purchase_number`='".$id."'";
										...
										if ($result) {
											while ($row = mysqli_fetch_array($result)) {
												...
												<div class="row">
													<div class="col-sm-6">
														<span style="font-size: 18px;font-weight: bolder"><?php echo $row['vendorName']; ?></span><br>
														Company Name : &ensp;&ensp;<span style="font-weight: bolder"><?php echo $row['companyName']; ?></span>
													</div>
													<div class="col-sm-6" style="text-align: right">
														Bill No. :<br>
														<span style="font-size: 16px;font-weight: bolder"><?php echo $row['purchase_code'].$row['purchase_number']; ?></span>
													</div>
												</div>
												<br>
												<div class="row">
													...
													<div class="col-sm-6" style="text-align: right">
														Purchase Date :<br>
														<span style="font-size: 16px;font-weight: bolder"><?php echo $row['purchaseDate']; ?></span><br>
														Delivery Date :<br>
														<span style="font-size: 16px;font-weight: bolder"><?php echo $row['deliveryDate']; ?></span>
													</div>
												</div>
												<br>
												<div class="row">
												...
												<?php 
												$code = 'PR-0';
												$query2 = "SELECT * FROM `purchase_items` WHERE `purchase_number`='".$code.$id."'";
