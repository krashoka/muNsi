...
if (isset($_POST['name'])) {
	$name = $_POST['name'];
	$query = "SELECT * FROM `vendor_contacts` WHERE CONCAT(`firstName`, `lastName`, `companyName`) LIKE '%".$name."%'";
...
if (isset($_POST['userName'])) {
	...
	$output= ' ';
	$query_two = "SELECT `billingAddress`,`billingCity`,`billingState`,`billingCountry`,`billingPinCode` FROM `vendor_contacts` WHERE CONCAT(`firstName`,'".$output."', `lastName`) = '".$userName."'";
...
if (isset($_POST['company'])) {
	...
	$output= ' ';
	$query_three = "SELECT `companyName` FROM `vendor_contacts` WHERE CONCAT(`firstName`,'".$output."', `lastName`) = '".$userName."'";
